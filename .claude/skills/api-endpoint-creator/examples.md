...
class ProjectController(
  ...
  suspend fun listProjects(
    @Valid @Body request: ProjectListRequest
  ): ProjectListResponse {
...
// List endpoints use a request body with offset/limit (NEVER page/size, NEVER @Get with query params).
// See API_DESIGN.md > List Endpoints.
@Serdeable
@Introspected
