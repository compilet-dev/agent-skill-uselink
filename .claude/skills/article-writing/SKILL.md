...
description: Write blog posts, guides, tutorials, and long-form content that sounds like a real person, not AI. Use when the user asks for an article, blog post, tutorial, technical guide, or wants to turn notes/research into long-form prose.
allowed-tools:
  - Read
  - Write
  - WebSearch
