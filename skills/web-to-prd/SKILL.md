---
name: web-to-prd
description: "Scan a live web app with Playwright, extract all features, generate PRD/epics/stories with priorities and dependencies, export to Notion. Use when reverse-engineering a web app, documenting an existing product, or building a backlog from a live app."
allowed-tools:
  - Read
  - Write
  - Bash
...
See the command file (`.claude/commands/spartan/web-to-prd.md`) for the full template with examples.
